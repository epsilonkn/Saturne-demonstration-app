...
def mWinCode(old_data : dict, data : dict, project_path : str) -> list:
    """mWinCode 
    Génère le code des paramètres de l'interface.

    Parameters
    ----------
    old_data : dict
        Anciennes données de l'interface
    data : dict
        Nouvelles données de l'interface
    project_path : str
    ...
    -------
    list
        Retourne le code du projet sous forme d'une liste
    """
...
def createWidCode(data : dict) -> list:
    """createWidCode 
    Génère le code d'un widget donné
    ...
    -------
    list
        Retourne le code sous forme d'une liste
    """
...
def mWidCode(old_data : list, new_data : list, project_path : str) -> list :
    """mWidCode 
    Modifie le code d'un widget donné, re-génère son ancien code, puis son nouveau, et remplace l'ancien par le nouveau dans le code

    Parameters
    ----------
    old_data : list
        Anciennes données du widget
    new_data : list
        Nouvelles données du widget
    project_path : str
        Chemin d'accès du projet
    ...
    -------
    list
        Retourne le code sous forme d'un liste
    """
...
def delWidCode(widget : str, wid_id : str, project_path : str) -> list:
    """delWidCode 
    Récupère le nom du widget et son id pour retrouver sa séquence d'initialisation dans le code et la supprimer

    Parameters
    ----------
    widget : str
        Nom du widget donné par l'utilisateur
    wid_id : str
        ID du widget
    project_path : str
        Chemin d'accès du projet
